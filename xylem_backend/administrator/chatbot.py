    ...
    TOOL_DEFINITION = [
        {
            ...
            "function": {
                "name": "search_person",
                "description": "Search for a person by name, age, gender (male or female) and return the reports of one or many person being missing or not. Display the provided data (point by point) in from this function call",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "name": {"type": "string"},
